...
const Comparison = () => {
  return (
    ...
    >
      ...
      <p>
        לאחר בחירת סוג הקרן ותכנית מסוימת מתוך הרשימה, תוכלו להזין סכום השקעה ובחירת תקופה (שנה, 3 שנים או 5 שנים). המערכת מחשבת את הערך העתידי של ההשקעה באמצעות נוסחת ריבית דריבית ומציגה זאת בצורה גרפית, עם גרף קו המדגים את צמיחת ההשקעה בכל שנה לאורך התקופה שנבחרה.
      </p>
      <p>
